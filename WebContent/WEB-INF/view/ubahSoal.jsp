...
<div class="card mb-3">
  ...
  <div class="card-body">
		<form method="POST" action="http://localhost:8000/admin/soal" accept-charset="UTF-8" enctype="multipart/form-data"><input name="_token" type="hidden" value="AkJlvvYCujA9EABMSaonbK5XFEaSvYkgjKUgKBPP">
